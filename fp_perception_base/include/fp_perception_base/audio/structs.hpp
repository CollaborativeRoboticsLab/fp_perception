...
/**
 * @brief Convert fp_perception::audio_data to fp_perception_msgs::msg::PerceptionAudio message.
 *
 * @param data The audio data to convert.
 * @return fp_perception_msgs::msg::PerceptionAudio The converted message.
 */
fp_perception_msgs::msg::PerceptionAudio audio_data_to_msg(const audio_data& data)
{
  fp_perception_msgs::msg::PerceptionAudio msg;
...
/**
 * @brief Convert fp_perception_msgs::msg::PerceptionAudio message to audio_data.
 *
...
{
  fp_perception_msgs::msg::PerceptionText msg;
